...
RSpec.describe "applicant_details/new", type: :view do
  before(:each) do
    assign(:applicant_detail, ApplicantDetail.new(
      :user => nil,
      :firstname => "MyString",
      :middlename => "MyString",
      :lastname => "MyString",
  ...
  it "renders new applicant_detail form" do
    render

    assert_select "form[action=?][method=?]", applicant_details_path, "post" do
