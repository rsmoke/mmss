...
set :deploy_to,       "/home/\#{fetch(:user)}/apps/mmss"
set :puma_bind,       "unix://\#{shared_path}/tmp/sockets/mmss-puma.sock"
...
namespace :deploy do
  ...
  #       execute("ln -nfs /home/deployer/apps/mmss/current/config/nginx.conf /etc/nginx/sites-enabled/mmss && rm /etc/nginx/sites-enabled/default")
  #     end
  #   end
  # end
