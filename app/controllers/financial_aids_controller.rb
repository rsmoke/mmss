class FinancialAidsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @financial_aid.save
        format.html { redirect_to @financial_aid, notice: 'Financial aid was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @financial_aid.update(financial_aid_params)
        format.html { redirect_to @financial_aid, notice: 'Financial aid was successfully updated.' }
  ...
  private
    ...
    def financial_aid_params
      params.require(:financial_aid).permit(:enrollment_id, :amount_cents, :source, :awarded, :note, :status)
    end
end
